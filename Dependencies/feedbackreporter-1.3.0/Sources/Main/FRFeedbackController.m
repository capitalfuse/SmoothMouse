...
{
    // Modified by SmoothMouse team to read SmoothMouse preferences
//    NSMutableDictionary *preferences = [[[[NSUserDefaults standardUserDefaults] persistentDomainForName:[FRApplication applicationIdentifier]] mutableCopy] autorelease];
    ...
    NSString *file = [NSHomeDirectory() stringByAppendingPathComponent: @"/Library/Preferences/com.cyberic.SmoothMouse.plist"];
    NSDictionary *preferences = [NSDictionary dictionaryWithContentsOfFile:file];
