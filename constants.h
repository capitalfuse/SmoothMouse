#define LAUNCHD_PLIST_FILENAME @"/Library/LaunchAgents/com.cyberic.smoothmouse.plist"
...
#define SETTINGS_MOUSE_ENABLED_DEFAULT YES
#define SETTINGS_TRACKPAD_ENABLED_DEFAULT YES
